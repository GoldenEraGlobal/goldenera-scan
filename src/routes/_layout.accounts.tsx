...
export const Route = createFileRoute('/_layout/accounts')({
    ...
    head: () => ({
        meta: [
            { title: m.meta_title_accounts({ appName: import.meta.env.VITE_APP_NAME || 'GE Explorer' }) },
            {
                name: 'description',
                content: m.meta_description_accounts({ appName: import.meta.env.VITE_APP_NAME || 'GE Explorer' }),
            },
        ],
    }),
})
